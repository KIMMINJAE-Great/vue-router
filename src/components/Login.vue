...
<template>
  ...
  <div id="loginBox">
    <form action="./main" class="login" ref="frmLogin">
      <fieldset id="loginFeildset">
        <legend>Login</legend>
        <div>
...
padding-top: 10rem;
  ...
  background: linear-gradient(to bottom, rgba(92, 77, 66, 0.8) 0%, rgba(92, 77, 66, 0.8) 100%), url("../assets/img/portfolio/fullsize/6.jpg");
